...
public class GamePanel extends JPanel implements Runnable{
    ...
    private void copyPieces(ArrayList<Piece> source, ArrayList<Piece> target) {
        ...
        // Kopiowanie pionków z listy źródłowej do listy docelowej
    ...
    public void paintComponent(Graphics g) {
        ...
        g2.fillRect(activeP.column*Board.SQUARE_SIZE, activeP.row*Board.SQUARE_SIZE, Board.SQUARE_SIZE, Board.SQUARE_SIZE); // Rysuje prostokąt pod aktywnym pionkiem.
